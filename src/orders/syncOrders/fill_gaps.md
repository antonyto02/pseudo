...
Si Binance responde ok, calcula sellPrice en ticks con `targetPrice + sellTickOffset` y asigna la compra al primer bloque null.
...
* Import ticksToPriceString()          from   price/conversion/ticks_to_string.rs
    ...
    function fillMissingBuyOrders(targetBuyPrices)
        ...
        for each targetPrice in targetBuyPrices:
            ...
            sellPrice = targetPrice + sellTickOffset
